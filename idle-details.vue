                ...
                <div class="details-header">
                    <div class="details-header-user-info">
                        ...
                        <div style="margin-left: 10px;">
                            ...
                            <div class="details-header-user-info-time">{{idleItemInfo.user.registerTime.substring(0,10)}} 加入平台</div>
                        </div>
                    </div>
                    <div class="details-header-buy" :style="'width:'+(isMaster?'150px;':'280px;')">
                        ...
                        <div v-if="!isMaster&&idleItemInfo.idleStatus!==1" style="color: red;font-size: 16px;">商品已下架或删除</div>
...
<style scoped>
     ...
     .bgc{
                ...
                height: 100%;
                width: 100%;
                 background: url("../img/gd15.jpg") no-repeat;
