 ...
 <div class="bgc">
        ...
        <app-body>
            ...
            <el-tabs v-model="labelName" type="card" @tab-click="handleClick">
                ...
                <el-tab-pane label="鱼竿租借" name="1"></el-tab-pane>
                <el-tab-pane label="鱼竿售卖" name="2"></el-tab-pane>
                <el-tab-pane label="渔轮" name="3"></el-tab-pane>
                <el-tab-pane label="鱼线" name="4"></el-tab-pane>
                <el-tab-pane label="鱼饵饲料" name="5"></el-tab-pane>
                <el-tab-pane label="渔具用品" name="6"></el-tab-pane>
                <el-tab-pane label="公告展示" name="7"></el-tab-pane>
                <el-tab-pane label="其他" name="8"></el-tab-pane>
            </el-tabs>
...
<style scoped>
    ...
    .bgc{
            ...
            height: 100%;
            width: 100%;
             background: url("F:\second-hand\frontend\src\components\img\VCG41N697179886.jpg") no-repeat;
