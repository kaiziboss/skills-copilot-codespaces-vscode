          ...
          <span v-show="this.mode != 3" class="app-title">
            ...
            <div v-show="this.mode ==3" class="addAdminButton">
                ...
                <el-dialog
                    ...
                    <el-input v-model="name"  maxlength="8" placeholder="请输入管理员名称" style="padding: 10px 0" clearable required></el-input>
                    <span style="margin-left: 10px">新增管理员账户</span>
                    <el-input v-model="number" minlength="8" maxlength="10" placeholder="请输入管理员账户" style="padding: 10px 0"
                               clearable required></el-input>
                    <span style="margin-left: 10px">新增管理员密码</span>
                    <el-input v-model="password" minlength="8" placeholder="请输入管理员密码" style="padding: 10px 0" show-password required></el-input>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            regAdmin(){
                if(this.password == this.adminRePassword){
