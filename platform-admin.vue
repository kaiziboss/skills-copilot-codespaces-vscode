...
<div style="background-color: #f6f6f6;min-height:100vh;">
		<el-container>
			<el-header>
				<div class="header">
					<div class="app-name">
						<router-link to="/platform-admin">渔具租借系统后台管理</router-link>
					</div>
						<span class="app-title">管理员:{{admin.name}}</span>
			...
			<el-container>
				<div class="mainBody">
					...
					<el-main>
						...
						<ShelfGoods v-if="mode == 4"></ShelfGoods>
					</el-main>
				</div>
			</el-container>
		</el-container>
...
import ShelfGoods from '../common/shelfGoods.vue'
