        ...
        <app-body>
            <div class="release-idle-container">
                ...
                <div class="release-idle-container-form">
                    <el-input placeholder="请输入商品标题" v-model="idleItemInfo.idleName"
                              maxlength="30"
                              show-word-limit>
                    </el-input>
                    <el-input
                    ...
                    <div style="display: flex;justify-content: center;margin-top: 30px;margin-bottom: 30px;">
                        ...
                        <el-button type="danger" plain @click="resetButton">取消发布</el-button>
                    </div>
                </div>
            </div>
            <app-foot></app-foot>
...
<style scoped>
      .bgc{
                 ...
                 height: 100vh;
                 width: 100%;
                  background: url("../img/gd20.jpg") no-repeat;
