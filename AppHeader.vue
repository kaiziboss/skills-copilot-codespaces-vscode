<template>
    <div class="header">
        <div class="header-container">
            ...
            <div class="app-name">
                <router-link to="/">渔具租借管理系统</router-link>
            </div>
            ...
            <div class="search-container">
                ...
                <el-input placeholder="请搜索您需要的商品..." v-model="searchValue" @keyup.enter.native="searchIdle">
    ...
    export default {
        ...
        data() {
            return {
                ...
                nickname:'登录',
                avatar:'http://localhost:8081/image?imageName=file17139560340481002微信图片_20220914214924.jpg',
                isLogin:false
            };
        },
        created(){
