        ...
        <app-body>
                ...
                <div class="user-info-container">
                    <div class="user-info-details">
                        ...
                        <div class="user-info-details-text">
                            ...
                            <div class="user-info-details-text-time">{{userInfo.registerTime}} 加入平台</div>
            ...
            <div v-show="eidtAddress" class="address-container">
                ...
                <div class="address-container-add">
                    ...
                    <div class="address-container-add-item">
                        <span class="demonstration">鱼坑类型/鱼坑编号/位置号</span>
                        <el-cascader
                                :options="options"
                    ...
                    <div class="address-container-add-item">
                        <el-input placeholder="钓位号 + 在钓位的左侧还是右侧" v-model="addressInfo.detailAddress"
    ...
    export default {
        ...
        methods: {
                ...
                this.$api.getAddress().then(res => {
                    if (res.status_code === 1) {
                        ...
                        for (let i = 0; i < data.length; i++) {
                            data[i].detailAddressText = data[i].dorm + data[i].building + data[i].floor + data[i].detailAddress;
            ...
            handleAddressChange(value) {
                console.log(value);
                this.addressInfo.dorm = value[0];
                this.addressInfo.building = value[1];
                this.addressInfo.floor = value[2];
            },
            handleEdit(index, row) {
                console.log(index, row);
                this.addressInfo = JSON.parse(JSON.stringify(row));
                this.selectedOptions = ['', '', ''];
                this.selectedOptions[0] = row.dorm;
                this.selectedOptions[1] = row.building;
                this.selectedOptions[2] = row.floor;
            },
